...
module.exports = {
  ...
  botName: "JackBOT",
  botVersion: "3.0.0",
  useInteractiveMenu: process.env.USE_INTERACTIVE_MENU !== "false", // Set to true if you want to use interactive buttons/dropdowns, but note it might not display on many WA clients.
